...
import { productsCobre } from '../data/cobre';
//import { Product } from '../types/types';
import { useCart } from '../context/CartContext'; 

const Cobre: React.FC = () => {
